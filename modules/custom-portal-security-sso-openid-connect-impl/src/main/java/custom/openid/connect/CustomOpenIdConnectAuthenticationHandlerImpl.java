...
public class CustomOpenIdConnectAuthenticationHandlerImpl
	implements OpenIdConnectAuthenticationHandler {
	
	@Activate
	protected void activate(Map<String, Object> properties) {
		if (_log.isInfoEnabled()) _log.debug("activated...");
	}
	...
	public void processAuthenticationResponse(
		...
		OIDCTokens oidcTokens = CustomOpenIdConnectTokenRequestUtil.request(
	...
	public void requestAuthentication(
		...
		_log.debug("requestAuthentication");
	...
	private AuthenticationSuccessResponse _getAuthenticationSuccessResponse(
		...
		try {
			...
			if (authenticationResponse instanceof AuthenticationErrorResponse) {
				...
				if (authenticationErrorResponse.getErrorObject() != null) _log.debug(transactionId + ", authenticationErrorResponse code: " + authenticationErrorResponse.getErrorObject().getCode() + ", description: " + authenticationErrorResponse.getErrorObject().getDescription() + ", HTTPStatusCode: " + authenticationErrorResponse.getErrorObject().getHTTPStatusCode());
				if (authenticationErrorResponse.getJWTResponse() != null) _log.debug(transactionId + ", authenticationErrorResponse JWTResponse: " + authenticationErrorResponse.getJWTResponse().getParsedString());
			...
			AuthenticationSuccessResponse authenticationSuccessResponse = (AuthenticationSuccessResponse)authenticationResponse;

			if (authenticationSuccessResponse.getAccessToken() != null) _log.debug(transactionId + ", authenticationSuccessResponse accessToken: " + authenticationSuccessResponse.getAccessToken().getValue() + ", lifetime: " + authenticationSuccessResponse.getAccessToken().getLifetime() + ", type: " + authenticationSuccessResponse.getAccessToken().getType().getValue());
			if (authenticationSuccessResponse.getAuthorizationCode() != null) _log.debug(transactionId + ", authenticationSuccessResponse authorizationCode: " + authenticationSuccessResponse.getAuthorizationCode().getValue());
			if (authenticationSuccessResponse.getIDToken() != null) _log.debug(transactionId + ", authenticationSuccessResponse IDToken: " + authenticationSuccessResponse.getIDToken().getParsedString());
			if (authenticationSuccessResponse.getJWTResponse() != null) _log.debug(transactionId + ", authenticationSuccessResponse JWTResponse: " + authenticationSuccessResponse.getJWTResponse().getParsedString());
	...
	private String _requestUserInfoJSON(
		...
		try {
			...
			if (userInfoResponse instanceof UserInfoErrorResponse) {
				...
				if (userInfoErrorResponse.getErrorObject() != null) _log.debug("userInfoErrorResponse code: " + userInfoErrorResponse.getErrorObject().getCode() + ", description: " + userInfoErrorResponse.getErrorObject().getDescription() + ", HTTPStatusCode: " + userInfoErrorResponse.getErrorObject().getHTTPStatusCode());
			...
			if (userInfo != null) _log.info("userInfoSuccessResponse emailAddress: " + userInfo.getEmailAddress());
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CustomOpenIdConnectAuthenticationHandlerImpl.class);
